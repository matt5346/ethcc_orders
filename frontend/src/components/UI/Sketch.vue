<template>
  <div class="sketch">
    <div class="sketch__logo">
      <a href="#">
        <svg heigh="30px" width="80px" viewBox="0 0 98 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <a href="#">
        <svg heigh="30px" width="30px" version="1.1" id="Слой_1" x="0px" y="0px" viewBox="0 0 1610 1610" style="enable-background:new 0 0 1610 1610;" xmlns="http://www.w3.org/2000/svg">
          <g>
            <path fill="#4485F4" class="st0" d="M805,0C360.4,0,0,360.4,0,805s360.4,805,805,805c167.1,0,322.4-50.9,451-138.1 c84.9-57.5,158.2-130.8,215.7-215.6C1559,1127.5,1610,972.2,1610,805C1610,360.4,1249.6,0,805,0z M1033.8,1249.7 C965.3,1285,887.5,1305,805,1305c-276.1,0-500-223.9-500-500s223.9-500,500-500s500,223.9,500,500c0,82.6-20,160.4-55.4,229.1 C1201.9,1126.4,1126.2,1202,1033.8,1249.7z" style="fill: rgb(22, 82, 240);"/>
          </g>
          <g>
            <circle fill="none" class="st1" cx="805" cy="805" r="500"/>
          </g>
          <g>
            <circle fill="none" class="st1" cx="805" cy="805" r="500"/>
          </g>
          <path class="st2"  fill="#FFBB00" d="M1471.7,1256.2c-57.5,84.8-130.8,158.1-215.7,215.6l-222.2-222.2l-228.9-228.9c-59.5-59.6-59.5-156.1,0-215.7 c29.8-29.8,68.8-44.7,107.8-44.7s78.1,14.9,107.8,44.7l229,229L1471.7,1256.2z" style="paint-order: fill; fill: rgb(254, 148, 49);"/>
        </svg>
      </a>
    </div>
